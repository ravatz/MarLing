#!/bin/bash
sfile="https://github.com/ravatz/MarLing/blob/main"
...
#Install Subs
wget -N -P /var/lib/marzban/templates/subscription/  https://raw.githubusercontent.com/ravatz/MarLing/main/index.html

#install env
wget -O /opt/marzban/.env "https://raw.githubusercontent.com/ravatz/MarLing/main/env"

#profile
echo -e 'profile' >> /root/.profile
wget -O /usr/bin/profile "https://raw.githubusercontent.com/ravatz/MarLing/main/profile";
...
wget https://github.com/ravatz/MarLing/raw/main/vnstat-2.6.tar.gz
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/ravatz/MarLing/main/nginx.conf"
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/ravatz/MarLing/main/vps.conf"
wget -O /etc/nginx/conf.d/xray.conf "https://raw.githubusercontent.com/ravatz/MarLing/main/xray.conf"
...
systemctl start nginx
wget -O /var/lib/marzban/xray_config.json "https://raw.githubusercontent.com/ravatz/MarLing/main/xray_config.json"
